const data = [
  {
    ...
    dImage: 'src="./img/received_381936387655343.png"',
  ...
  },
  {
    ...
    cImg: 'src="./img/received_531702158939993.jpeg"',
    cTechnologies: ['Java', 'Netbeans'],
    cbutton: 'See Project',
    mImage: 'src="./img/received_531702158939993.jpeg" alt="" ',
    dImage: 'src="./img/received_531702158939993.jpeg"',
    header: 'Online Shop',
    descrip:
      'This project is a Attendance QR Code Scanner.',
  },
  {
    cTitle: 'Arduino Uno',
    cImg: 'src="./img/received_755171256748828.jpeg"',
    cTechnologies: ['Arduino'],
    cbutton: 'See Project',
    mImage: 'src="./img/received_755171256748828.jpeg" alt="" ',
    dImage: 'src="./img/received_755171256748828.jpeg"',
